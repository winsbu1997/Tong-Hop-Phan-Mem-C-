...
namespace QuanLyThuVien.DAO
{
    class DangMuon_DAO : DataProvider
    {
        ...
        {
            string sqlString = @"select DOCGIA.HoTen, SACH.TenSach, PHIEUMUON.NgayMuon, PHIEUMUON.NgayPhaiTra from SACH, DOCGIA, PHIEUMUON where SACH.MaSach = PHIEUMUON.MaSach and PHIEUMUON.MaDocGia = DOCGIA.MaDocGia";
